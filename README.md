...
![alt text](https://github.com/YangHuNU/raw/Screenshots/ListToDo.PNG "Start")

Delete one item and added two, now the app looks like this:
![alt text](https://github.com/YangHuNU/raw/Screenshots/ListToDo_afterModified.PNG "Modified")
...
![alt text](https://github.com/YangHuNU/raw/Screenshots/AWS_Test_Result.PNG "AWS Result")

Here are sample screenshots from some devices:
Pixel:
![alt text](https://github.com/YangHuNU/raw/Screenshots/Pixel_ScreenShots.PNG "Pixel")

Galaxy 6:
![alt text](https://github.com/YangHuNU/raw/Screenshots/Samsung_ScreenShots.PNG "Galaxy6")

Pixel 2:
![alt text](https://github.com/YangHuNU/raw/Screenshots/Pixel2_ScreenShots.PNG "Pixel2")

#### Reference
The app is made by following [the tutorial video](https://www.google.com) with my own customization. 
